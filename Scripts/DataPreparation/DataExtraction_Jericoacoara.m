...
folder_SiteMetadata = '../../Metadata/Jericoacoara/'; %folder with site metadata
folder_LoggerRawData = '../../../../Google Drive/Data/AeolianFieldwork/Raw/Datalogger/Jericoacoara/'; %folder with logger raw data tables
...
Metadata_Path = strcat(folder_DataOutput,'Metadata_Jericoacoara'); %get path to saving metadata
...
GrainSize_Surface = GetGrainSize(GrainSizeMetadata_Surface,folder_GrainSize); %import surface grain size files
GrainSize_BSNE = GetGrainSize(GrainSizeMetadata_BSNE,folder_GrainSize); %import BSNE grain size files
