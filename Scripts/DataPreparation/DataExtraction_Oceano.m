...
folder_SiteMetadata = '../../Metadata/Oceano/'; %folder with site metadata
folder_LoggerRawData = '../../../../Google Drive/Data/AeolianFieldwork/Raw/Datalogger/Oceano/'; %folder with logger raw data tables
...
Metadata_Path = strcat(folder_DataOutput,'Metadata_Oceano'); %get path to saving metadata
