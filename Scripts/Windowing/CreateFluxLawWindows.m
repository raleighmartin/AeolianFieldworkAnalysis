...
TimeWindow_Path = strcat(folder_WindowingData,'TimeWindows_Analysis'); %path for loading time windows
SaveData_Path = strcat(folder_WindowingData,'FluxLawWindows_Analysis'); %path for saving output data

% %% Specific information for analysis - Kenyon
% TimeWindow_Path = strcat(folder_WindowingData,'TimeWindows_Oceano_Kenyon'); %path for loading time windows
% SaveData_Path = strcat(folder_WindowingData,'FluxLawWindows_Oceano_Kenyon'); %path for saving output data

% %% Specific information for analysis - Yue
% TimeWindow_Path = strcat(folder_WindowingData,'TimeWindows_Oceano_Yue'); %path for loading time windows
% SaveData_Path = strcat(folder_WindowingData,'FluxLawWindows_Oceano_Yue'); %path for saving output data
