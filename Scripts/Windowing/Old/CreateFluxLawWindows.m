...
%LoadData_Path = strcat(folder_LoadData,'DataWindows_30min_Thresholds'); %path for 30 minute data - for thresholds analysis
LoadData_Path = strcat(folder_LoadData,'DataWindows_30min_Thresholds_Jeri'); %path for 30 minute data - for thresholds analysis
load(LoadData_Path);
...
%SaveData_Path = strcat(folder_SaveData,'FluxLawWindows_30min_Thresholds'); %path for 30 minute data - for thresholds analysis
SaveData_Path = strcat(folder_SaveData,'FluxLawWindows_30min_Thresholds_Jeri'); %path for 30 minute data - for thresholds analysis
