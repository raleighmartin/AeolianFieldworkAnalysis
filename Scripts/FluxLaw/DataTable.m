...
folder_AnalysisData = '../../AnalysisData/FluxLaw/'; %folder for outputs
...
load(strcat(folder_AnalysisData,'FluxLawData_Binned'));
...
for i = 1:N_Sites
    SiteTable{1,i+1} = [num2str(d10_surface_site(i),'%.2f'), '+/-',num2str(sigma_d10_surface_site(i),'%.2f')];
    SiteTable{2,i+1} = [num2str(d50_surface_site(i),'%.2f'), '+/-',num2str(sigma_d50_surface_site(i),'%.2f')];
    SiteTable{3,i+1} = [num2str(d90_surface_site(i),'%.2f'), '+/-',num2str(sigma_d90_surface_site(i),'%.2f')];
